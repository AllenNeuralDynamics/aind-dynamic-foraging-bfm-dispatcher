...
- **W&B group:** `gru-kwak-matched-half@20260905-232924`
- **Beaker experiment:** [`01M1TPMPJJNBHT2RT5WHR8KRJS`](https://beaker.org/ex/01M1TPMPJJNBHT2RT5WHR8KRJS)
...
**Headline.** Kwak Stage-A embedding-only transfer completed on the complete admitted cohort. Only the external subject embedding was adapted for 500 steps at learning rate 0.001; the source GRU core remained frozen.
