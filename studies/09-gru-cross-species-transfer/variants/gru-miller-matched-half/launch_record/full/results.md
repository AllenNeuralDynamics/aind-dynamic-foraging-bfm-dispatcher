...
**Headline.** Miller Stage-A embedding-only transfer is running on the complete admitted cohort. Only the external subject embedding is adapted for 500 steps at learning rate 0.001; the source GRU core is frozen.
