...
- **W&B group:** `gru-miller-matched-half@20260905-232924`
- **Beaker experiment:** [`01M1TPMHVARYQ17AYFSSTFCACS`](https://beaker.org/ex/01M1TPMHVARYQ17AYFSSTFCACS)
...
**Headline.** Miller Stage-A embedding-only transfer completed on the complete admitted cohort. Only the external subject embedding was adapted for 500 steps at learning rate 0.001; the source GRU core remained frozen.
