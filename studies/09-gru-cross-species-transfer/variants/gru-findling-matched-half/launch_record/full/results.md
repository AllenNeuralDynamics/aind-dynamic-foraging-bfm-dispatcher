...
**Headline.** Findling Stage-A embedding-only transfer completed on the complete admitted cohort. Only the external subject embedding was adapted for 500 steps at learning rate 0.001; the source GRU core remained frozen.
