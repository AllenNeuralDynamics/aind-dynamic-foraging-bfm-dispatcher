...
| Eckstein (human) | Human; stochastic reversal across development | [OSF `7wuh4`](https://osf.io/7wuh4/) (no explicit OSF data license) | 306 | 306 | 40,229 | 20,248 | v2 | co-winners: hierarchical RL and Bayesian-inference models | High; two hierarchical winners and paper reports an analytic n=291 | Admitted; GRU and common Q completed and frozen; exact trial-key parity passed |
