...
| Costa (macaque) | feedback-dependent RL | Published equations | Matched-half subject fitting replaces the paper's phase-specific fitting protocol | Implemented; matched-half fit pending | High for equations; moderate for paper-level fitting parity |
