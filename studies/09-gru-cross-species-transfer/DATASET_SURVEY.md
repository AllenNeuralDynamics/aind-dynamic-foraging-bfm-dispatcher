...
| Costa (macaque) | Macaque; stochastic stimulus reversal | [Zenodo record 20086410](https://doi.org/10.5281/zenodo.20086410), CC BY 4.0 | 11 | 245 | 329,840 | 162,960 | v1 | feedback-dependent RL with separate positive/negative learning rates | Moderate; equations are published, original fitting code not found | Reward-column correction validated; corrected E4, E8, and author-model fits completed; corrected common-Q fit running |
| López-Yépez (mouse) | Mouse; baited variable-interval dynamic matching | [Figshare v1](https://doi.org/10.6084/m9.figshare.14540283.v1), CC BY 4.0 | 8 | 218 | 147,726 | 77,662 | v1 | double-trace RL with fast and slow choice traces | Moderate; equations are published, MATLAB implementation was not released with the data | GRU and common Q completed; double-trace author-model fit running |
...
| López-Yépez (mouse) | double-trace RL | Published MATLAB equations | Original data-fit code and initialization details are not in the release | Implemented; matched-half fit pending | High for equations; moderate for paper-level fitting parity |
