...
| Costa (macaque) | Macaque; stochastic stimulus reversal | [Zenodo record 20086410](https://doi.org/10.5281/zenodo.20086410), CC BY 4.0 | 11 | 245 | 329,840 | 162,960 | v1 | feedback-dependent RL with separate positive/negative learning rates; matched benchmark adds shape-choice bias | Moderate; equations are published, original fitting code not found | Completed after reward-column correction; corrected E4, E8, Bari2019, and bias-augmented author-family fits have exact held-out trial-key parity |
...
| Costa (macaque) | feedback-dependent RL plus fitted shape-choice bias | Published equations for the three-parameter core; bias is our declared augmentation | Matched-half subject fitting replaces the paper's phase-specific fitting protocol | Implemented; bias-augmented matched-half fit completed | High for core equations; moderate for paper-level fitting parity |
...
The primary set passed this gate first. Alsiö (rat), Costa (macaque), and
López-Yépez (mouse) were then explicitly selected for the second
