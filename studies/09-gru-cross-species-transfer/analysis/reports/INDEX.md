...
|---|---|---|---|
| [r1](r1-author-aligned-baselines.md) | external-transfer-all-baselines | live | E4 scaling and E8 D=614 are shown against Bari2019 common Q and available author models for all 12 valid cohorts |
| [r2](r2-embedding-space.md) | transferred-subject-embedding-space | live | All 12 external cohorts are farther than held-out AIND mice in both spaces; their E4/E8 distance ranks correlate 0.902 |
