...
| [r4](r4-embedding-dimension-transfer.md) | embedding-dimension-transfer | live | E8 is neutral on the two close mouse tasks but improves Miller (rat), Findling (human), and Eckstein (human); expand the screen |
