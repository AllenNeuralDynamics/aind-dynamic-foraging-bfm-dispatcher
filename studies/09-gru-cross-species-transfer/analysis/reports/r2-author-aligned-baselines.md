...
# Result 2 — External transfer: GRU, common Q, and author-aligned baselines

This consolidated result compares the frozen-core transferred GRU across every source D with
both our common sticky Q-learning control and the behavioral models selected in each source paper.
