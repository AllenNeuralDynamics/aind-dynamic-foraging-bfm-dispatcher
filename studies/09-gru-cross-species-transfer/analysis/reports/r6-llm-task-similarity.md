...
Across all 12 valid cohorts, LLM task distance to AIND versus GRU−Bari2019 normalized-likelihood advantage has Spearman ρ=-0.611 (permutation p=0.0391). Among the 11 cohorts with an author-model reference, the GRU−author association is ρ=+0.100 (p=0.7594).
