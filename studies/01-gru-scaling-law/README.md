...
| [`e4-e8-d614-source`](variants/e4-e8-d614-source/notes.md) | Paired current-code E={4,8}, D=614 source cores; three seeds per dimension for held-out AIND and Study 09 transfer | running (6/6 started) | `e4-e8-d614-source@20260906-195409` | [`01M1WWK9HP269XQS440Y29631F`](https://beaker.org/ex/01M1WWK9HP269XQS440Y29631F) |
