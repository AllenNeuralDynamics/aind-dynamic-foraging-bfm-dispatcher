...
| [`e4-e8-d614-source`](variants/e4-e8-d614-source/notes.md) | Paired current-code E={4,8}, D=614 source cores; three seeds per dimension for held-out AIND and Study 09 transfer | ready to launch | pending | pending |
