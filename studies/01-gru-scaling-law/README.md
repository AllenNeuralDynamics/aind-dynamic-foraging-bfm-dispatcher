...
| [`e8-d614-smoke`](variants/e8-d614-smoke/notes.md) | Non-scientific one-task plumbing check for an eight-dimensional subject embedding at D=614 | running | `e8-d614-smoke@20260906-192034` | [`01M1WTNQSMRKSKCWD1Q6CXRPHT`](https://beaker.org/ex/01M1WTNQSMRKSKCWD1Q6CXRPHT) |
| [`e4-e8-d614-source`](variants/e4-e8-d614-source/notes.md) | Paired current-code E={4,8}, D=614 source cores; three seeds per dimension for held-out AIND and Study 09 transfer | blocked on smoke | pending | pending |
